...
The protected studio includes a read-only ebook reader for all 298 imported workbook pages, plus source-page search, chapter navigation, page navigation, practice jumps, interactive study lenses with save-and-track prompts, material packs, exam mode, writing vault, pronunciation/TTS work, review tracking, and teacher notes.
