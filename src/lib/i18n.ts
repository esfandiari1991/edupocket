...
const tagLabels: Record<string, string> = {
  ...
  "Business English": "انگلیسی کسب‌وکار",
...
export const commonText = {
  ...
  builtFor: {
    ...
    fa: "برای دانش‌آموزان، معلم‌ها، خودآموزها و سازنده‌هایی که سیستم یادگیری کاربردی می‌سازند.",
  },
  builtWith: { en: "Built by Blue Rose Academy (Ali Esfandiari Rad).", fa: "ساخته‌شده توسط Blue Rose Academy (Ali Esfandiari Rad)." },
  audioSoon: { en: "Audio Soon", fa: "فایل صوتی به‌زودی" },
