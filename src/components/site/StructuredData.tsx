...
export function StructuredData() {
  ...
  const primaryPages = [
    { name: "Eva Digital Booklet by EduPocket", url: `${base}/eva-digital-booklet`, description: "EduPocket's first premium digital product by Ali Rad: private IELTS and TOEFL-style reading and writing practice." },
