...
export const metadata: Metadata = {
  ...
  title: {
    default: `${siteConfig.name} - CELTA English Teacher, IELTS, TOEFL, FCE, ESP, GRE & GMAT Coaching`,
  ...
  openGraph: {
    ...
    title: `${siteConfig.name} - CELTA English Teacher, IELTS, TOEFL, FCE, ESP, GRE & GMAT Coaching`,
    description: siteConfig.description,
    locale: "en_US",
