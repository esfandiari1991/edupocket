...
export const metadata: Metadata = {
  ...
  description: "A premium study product by Ali Rad inside EduPocket: a private Eva Digital Booklet gateway for structured IELTS and TOEFL-style reading and writing practice.",
  ...
  openGraph: {
    ...
    description: "A premium study product by Ali Rad inside EduPocket: structured reading and writing practice in a premium-member study portal.",
